...
export default function UserVetList() {
        ...
        .then(querySnapshot => {
          ...
          querySnapshot.forEach(doc => {
            ...
            List.push({
              ...
              postAbout: postAbout,
              postImage: postImage,
              postClinicName: postClinicName,
              postAddress: postAddress,
              postCity: postCity,
              postName: postName,
              postEmail: postEmail,
              userId: userId,
              postProfession: postProfession,
  ...
  const renderItem = ({item}) => (
    <View style={styles.container}>
      ...
      <View style={styles.value}>
        <Text style={styles.heading}>Expert Name: </Text>
        <Text style={styles.text}>{item.postName}</Text>
      </View>
      <View style={styles.value}>
        <Text style={styles.heading}>About: </Text>
        <Text style={styles.text}>{item.postAbout}</Text>
      </View>
      <View style={styles.value}>
        <Text style={styles.heading}>Profesional Type: </Text>
        <Text style={styles.text}>{item.postProfession}</Text>
      </View>
      <View style={styles.value}>
      ...
      <View style={styles.value}>
        ...
        <Text style={styles.text}>{item.postServices}</Text>
      </View>
      <View style={styles.value}>
      ...
      <View style={styles.value}>
        ...
        <Text style={styles.text}>{item.postEmail}</Text>
      </View>
      <View style={styles.desValue}>
        <Text style={styles.heading}>Address: </Text>
        <Text style={styles.descText}>{item.postAddress}</Text>
      </View>
      <View style={styles.line}></View>
      <View style={styles.buttons}>
        <TouchableOpacity
          onPress={() => {
            navigation.navigate('ServiceListForm', {
              data: item,
              type: 'edit',
            });
          }}>
  ...
  return (
    <View style={styles.main}>
      <ListHeader heading="User Expert List" />
