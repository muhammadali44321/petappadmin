...
export default function PetListForm() {
  ...
  const [animalType, setAnimalType] = useState(
    route.params.type == 'edit' ? route.params.data.postAnimalType : '',
  );
  const [city, setCity] = useState(
    route.params.type == 'edit' ? route.params.data.postCity : '',
  );
  const [petName, setPetName] = useState(
    route.params.type == 'edit' ? route.params.data.postPetName : '',
  );
  ...
  const animalTypes = [
    {label: 'Animal type', value: ''}, // Empty initial option
    {label: 'Dog', value: 'Dog'},
    {label: 'Cat', value: 'Cat'},
    {label: 'Hen', value: 'Hen'},
  ];
  ...
  return (
    <View style={styles.container}>
      <Headers heading="Pet listing edit Form" />
      <ScrollView>
