...
export default function UserPetList() {
  ...
  const renderItem = ({item}) => (
    <View style={styles.container}>
      ...
      <View style={styles.value}>
        ...
        <Text style={styles.text}>{item.postPetName}</Text>
      </View>
      <View style={styles.value}>
      ...
      <View style={styles.value}>
        ...
        <Text style={styles.text}>{item.postAnimalType}</Text>
      </View>
      <View style={styles.value}>
      ...
      <View style={styles.buttons}>
        <TouchableOpacity
          onPress={() => {
            navigation.navigate('PetListForm', {
              data: item,
              type: 'edit',
            });
          }}>
  ...
  return (
    <View style={styles.main}>
      <ListHeader heading="User Pet List" />
